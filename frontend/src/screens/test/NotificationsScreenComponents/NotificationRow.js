...
import DiscourseUtils from '../../../discourseHelper/DiscourseUtils';
  ...
  _textForNotification(notification) {
    ...
    switch (notification.notification_type) {
      ...
      case 20:
        innerText = (
          <Text style={textStyle}>
            {{title: notification.fancy_title}}
      ...
      case 29:
        ...
        break;
      case 30:
        innerText = <Text style={textStyle}>{'chat_message'}</Text>;
        break;
      case 31:
        innerText = <Text style={textStyle}>{'chat_invitation'}</Text>;
        break;
      case 32:
        innerText = (
          <Text style={textStyle}>
        ...
        break;
      case 37:
        innerText = <Text style={textStyle}>{'new_features'}</Text>;
        break;
      case 34:
        innerText = (
          <Text style={textStyle}>
